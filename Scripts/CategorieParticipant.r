...
### Requête pour calculer le min, max et moyenne des polluants pour les participants sportifs et non sportifs
sql1 ="SELECT  
        CASE 
...
### Requête pour calculer le min, max et moyenne des polluants pour les participants fumeurs et non fumeurs
sql2 ="SELECT  
	    CASE  
...
### Requête pour calculer le min, max et moyenne des polluants pour les participants exposés à la fumée	
...
### Requête pour calculer le min, max et moyenne des polluants pour les participants propriétaire et locataires			
sql5 ="SELECT
		CASE
...
### Requête pour calculer le min, max et moyenne des polluants pour les participants classifiés selon leurs revenus		
sql6 ="SELECT
		CASE
...
### Requête pour calculer le min, max et moyenne des polluants pour les participants selon l'utilisation de transport en commun			
sql7 ="SELECT
		CASE
...
### Requête pour calculer le min, max et moyenne des polluants pour les participants utilisants mode doux de transport (vélo, ....)		
sql8 ="SELECT
		CASE	
...
### Requête pour calculer le min, max et moyenne des polluants pour les participants selon l'age
sql9 ="SELECT
		CASE	
...
### Requête pour calculer le min, max et moyenne des polluants pour les participants selon le sexe	
sql10 ="SELECT
		CASE	
		WHEN  q_58='Un homme'
		THEN 'Un homme'
...
PolluantParCategorie<-rbind(resultat1,resultat2,resultat3,resultat4,resultat5,resultat6,resultat7,resultat8,resultat9,resultat10)
